...
function addBooking($customer_id, $activity_id, $employee_id, $booking_date) {
    $conn = getConnection();
...
function addPayment($booking_id, $amount) {
    $conn = getConnection();
    $sql = "INSERT INTO payments(booking_id, amount, payment_status) VALUES('$booking_id', '$amount', 'paid')";
    return mysqli_query($conn, $sql);
}
